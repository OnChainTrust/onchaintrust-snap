      ...
      <Box>
        <Box center={false} direction="horizontal" key="el-0">
          {[
            <Address
              key="el-0-child-1"
              address="0x00000000000000000000000000000000f0cacc1a"
              avatar={true}
              displayName={true}
              truncate={false}
            />,
      ...
      <Box>
        <Box key="el-0" center={false} direction="horizontal">
          {[
            <Address
              key="el-0-child-1"
              address="0x00000000000000000000000000000000baadf00d"
              avatar={true}
              displayName={true}
              truncate={false}
            />,
        ...
        <Banner key="el-1" severity="warning" title="Unverified address">
          {[
            <Text key="el-1-banner-0">
              Information provided by the owner was not verified. Make sure you
              trust this address.
            </Text>,
          ]}
        </Banner>
      ...
      <Box>
        <Box key="el-0" center={false} direction="horizontal">
          {[
            <Address
              key="el-0-child-1"
              address="0x000000000000000000000000000000001abe11ed"
              avatar={true}
              displayName={true}
              truncate={false}
            />,
        ...
        <Banner key="el-3" severity="success" title="Whitelisted">
          {[
            <Text key="el-3-banner-0">
              This address is explicitly whitelisted to be used on
              onchaintrust.org
            </Text>,
          ]}
        </Banner>
      ...
      <Box>
        <Box key="el-0" center={false} direction="horizontal">
          {[
            <Address
              key="el-0-child-1"
              address="0x0000000000000000000000000000000000b0bbed"
              avatar={true}
              displayName={true}
              truncate={false}
            />,
      ...
      <Box>
        {[
          ...
          >
            {[
              <Text key="el-0-banner-0">
                Message from the Website Owner: The website is under attack.
    ...
    expect(screen).toRender(
      <Box>
        {[
          <Banner
            key="el-0"
            title="Security Alert: Potentially Unsafe Action Detected!"
            severity="danger"
          >
            {[
              <Text key="el-0-banner-0">
                STOP: Your transaction is directed towards an address that has
                been flagged for suspicious activity. Engaging with this address
                may result in the loss of your digital assets or compromise your
                personal security.
              </Text>,
            ]}
          </Banner>,
